...
export default function detailTechnical() {
    const { id } = useParams();
    ...
    if (!report) {
        return (
            <div className="grid justify-center items-center h-screen">
                <div className="flex justify-center text-center items-center w-screen text-3xl font-bold">
                    Loading...
                </div>
            </div>
        );
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <form className="space-y-6">
                <div className="flex gap-4">
                    <div className="w-full flex gap-4">
                        <p className="font-bold lg:text-lg md:text-sm sm:text-sm">
                            Priority
                        </p>
                        <p
                            className={`font-bold underline ${report.priority === "urgent" ? "text-red-500" : "text-blue-500"
                                }`}
                        >
                            {report.priority}
                        </p>
                    ...
                    <div className="w-full flex gap-4">
                        ...
                        <p className="underline lg:text-lg md:text-xs sm:text-xs">
                            {report.ref_no}
                        </p>
                    </div>
                </div>
                <div className="flex gap-4">
                    <div className="w-full flex gap-4">
                        ...
                        <p className="lg:text-lg md:text-xs sm:text-xs underline">
                            {report.topic}
                        </p>
                    </div>
                    <div className="w-full flex gap-4">
                ...
                <div className="lg:flex md:flex sm:grid gap-4 w-full">
                    ...
                    <div className="w-full">
                        <p className="lg:text-lg md:text-sm sm:text-sm">
                            สาเหตุความผิดปกติเบื้องต้น
                        </p>
                        <p className="border rounded-lg px-4 py-2">
                            {report.summary_incident}
                        </p>
                    </div>
                </div>
                <div className="lg:flex md:flex sm:grid gap-4 w-full">
            ...
            <Modal open={open} onClose={() => setOpen(false)}>
                <div className="flex flex-col gap-4">
                    <h1 className="text-2xl justify-center">ยืนยันการตรวจสอบ</h1>
                    <p></p>
               ...
               bg-blue-500 hover:bg-blue-600 text-white"
                        ...
                        <button
                            ...
                            className="border border-green-300 rounded-lg py-1.5 px-10
