    ...
    <div className="overflow-x-auto mt-16 py-4">
      <div className='grid justify-center items-center'>
        <div className="flex justify-center gap-10 mb-6" >
          <a
            href="/production"
            className="md:text-lg sm:text-sm py-4 hover:bg-red-600 gap-2 text-white h-14 w-72 flex items-center justify-center rounded-2xl bg-red-500 shadow-md drop-shadow-md border shadow-gray-200 hover:shadow-white">
