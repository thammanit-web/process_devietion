      ...
      <div className='grid justify-center items-center'>
        ...
        <div className="flex justify-center gap-10" >
          <div className='grid justify-center gap-8'>
            ...
            <a href="/schedule" className="md:text-lg sm:text-sm gap-2 py-4 hover:bg-green-600 text-white h-14 w-72 md:w-72 sm:w-36 flex items-center justify-center rounded-2xl bg-green-500 shadow-md drop-shadow-md border shadow-gray-200 hover:shadow-white">
            ...
            <a href="/maintenance_page" className="md:text-lg sm:text-sm gap-2 py-4 hover:bg-green-600 text-white h-14 w-72 md:w-72 sm:w-36 flex items-center justify-center rounded-2xl bg-green-500 shadow-md drop-shadow-md border shadow-gray-200 hover:shadow-white">
              <svg className="w-6 h-6 text-gray-200 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/status" className="md:text-lg sm:text-sm py-4 gap-2 hover:bg-green-600 text-white h-14 w-72 md:w-72 sm:w-36 flex items-center justify-center rounded-2xl bg-green-500 shadow-md drop-shadow-md border shadow-gray-200 hover:shadow-white">
              <svg className="w-6 h-6 text-gray-200 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className='grid justify-center gap-8'>
            ...
            <a href="/technical" className="hover:bg-green-600 md:text-lg sm:text-sm py-4 gap-2 text-white h-16 w-72 md:w-72 sm:w-40 flex items-center justify-center rounded-2xl bg-green-500 text-center shadow-md drop-shadow-md border shadow-gray-200 hover:shadow-white">
              <svg className="w-6 h-6 text-gray-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/manager_page" className="hover:bg-green-600 md:text-lg sm:text-sm gap-2 py-4 text-white h-14 w-72 md:w-72 sm:w-36 flex items-center justify-center rounded-2xl bg-green-500 shadow-md drop-shadow-md border shadow-gray-200 hover:shadow-white">
              <svg className="w-6 h-6 text-gray-200 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/history" className="hover:bg-green-600 md:text-lg sm:text-sm gap-2 py-4 text-white h-14 w-72 md:w-72 sm:w-36 flex items-center justify-center rounded-2xl bg-green-500 shadow-md drop-shadow-md border shadow-gray-200 hover:shadow-white">
